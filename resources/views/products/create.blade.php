<x-guest-layout>
    <div class="container mx-auto px-6">
        ...
        <div class="grid gap-5 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
            <div class="mb-5">
                <div class="">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="shadow sm:rounded-md sm:overflow-hidden"
                        ...
                        @csrf
                        <div class="mx-2 bg-white space-y-2 sm:p-6">
                            <div>
                            ...
                            <div>
                                ...
                                @error('price')<span class="text-md font-bold text-red-500 text-sm">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div
                                class="mt-1  flex justify-center px-6 pt-2 pb-2 border-2 border-gray-300 border-dashed rounded-md">
            ...
            <div>
                <img src="../../../images/Assorted_Bright_T_Shirts_large.jpg">
            </div>
        </div>
    </div>
</x-guest-layout>
